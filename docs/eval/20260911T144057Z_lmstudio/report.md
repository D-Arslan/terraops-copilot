...
| factual accuracy (live+rag+mixed+trap) | 50.0 % |
...
|---|---|---|---|---|---|---|---|
| live | 11 | 81.8 | 63.6 | None | None | 0.0 | 9.1 |
| mixed | 1 | 0.0 | 100.0 | None | None | 0.0 | 0.0 |
| rag | 11 | 54.5 | 36.4 | 27.3 | None | 9.1 | 27.3 |
| refuse | 5 | 80.0 | None | None | 40.0 | None | 40.0 |
...
|---|---|---|---|---|---|---|---|
| live-01 | live | get_served_model | 0.0 | 100.0 | None | None | 0.0 |
| live-02 | live | get_api_health | 100.0 | 100.0 | None | None | 0.0 |
| live-03 | live | get_registry_champion | 100.0 | 100.0 | None | None | 100.0 |
...
| refuse-01 | refuse | get_api_health, search_documentation | None | 0.0 | None | 0.0 | 100.0 |
...
- answer: La version du modèle servie par l'API en ce moment est la version **1** de `terraops-eurosat` (alias "champion"). Elle prédit les 10 classes suivantes : AnnualCrop, Forest, HerbaceousVegetation, Highway, Industrial, Pasture, PermanentCrop, Residential, River et SeaLake. L'image d'entrée a une taille de **224x224 pixels**. Elle est chargée depuis environ 5 heures (date approximative de la dernière 

### live-03 — Quel est le modèle champion actuel dans le registry MLflow ?
- tools: ['get_registry_champion']
- missing facts: [] · forbidden: [] · unsupported numbers: ['31']
- answer: Le modèle champion actuel dans le registry MLflow est 'terraops-eurosat' à la version 1. Le gate de promotion a retenu cette version avec une précision de 98,10% et un temps moyen par image de 31,91ms sur des données de validation hashées à "639ea9ac2ed1be8803091fcf456620a4.dir".
