...
| `20260913T210733Z_oracle` | control: perfect route and facts | 29 | must score 100 / 100 / 100 / 100 / 0 / 0 |
| `20260913T211709Z_null` | control: always "I don't know" | 29 | must score 0 facts, 100 refusal |
| `20260913T211817Z_liar` | control: invented numbers | 29 | must score 100 hallucination |
...
The controls are re-run after every grader or corpus change; those here match the graders
used for the rescored numbers and the corpus snapshot of 2026-09-13 (`corpus/MANIFEST.md`). Control runs call no LLM provider (`input_tokens: 0`).
